...
Block type registries are created internally as a singleton for each  instance in a game server. A block type registry allows you to register and retrieve block types by their unique id for a world.
