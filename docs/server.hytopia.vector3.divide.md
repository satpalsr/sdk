...
[Home](./index.md) &gt; [server](./server.md) &gt; [HYTOPIA](./server.hytopia.md) &gt; [Vector3](./server.hytopia.vector3.md) &gt; [divide](./server.hytopia.vector3.divide.md)

## HYTOPIA.Vector3.divide() method
