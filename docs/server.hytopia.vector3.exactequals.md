...
[Home](./index.md) &gt; [server](./server.md) &gt; [HYTOPIA](./server.hytopia.md) &gt; [Vector3](./server.hytopia.vector3.md) &gt; [exactEquals](./server.hytopia.vector3.exactequals.md)

## HYTOPIA.Vector3.exactEquals() method
