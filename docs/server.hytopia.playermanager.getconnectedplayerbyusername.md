...
[Home](./index.md) &gt; [server](./server.md) &gt; [HYTOPIA](./server.hytopia.md) &gt; [PlayerManager](./server.hytopia.playermanager.md) &gt; [getConnectedPlayerByUsername](./server.hytopia.playermanager.getconnectedplayerbyusername.md)

## HYTOPIA.PlayerManager.getConnectedPlayerByUsername() method
