...
[Home](./index.md) &gt; [server](./server.md) &gt; [HYTOPIA](./server.hytopia.md) &gt; [Quaternion](./server.hytopia.quaternion.md) &gt; [exactEquals](./server.hytopia.quaternion.exactequals.md)

## HYTOPIA.Quaternion.exactEquals() method
